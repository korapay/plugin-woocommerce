    ...
    var paymentRequest = async function () {
        ...
        var errorCallback = function (response) {
            ...
            if (response.reference === null) {
                $form.append('<input type="hidden" class="korapay_referenceKey" name="korapay_referenceKey" value="' + korapay_params.orderId + '"/>');
                $form.append('<input type="hidden" class="modal_failure" name="modal_failure" value="' + message + '"/>');
                $form.submit();
                return
            }
            
            //Append the reference and error to the form
            $form.append('<input type="hidden" class="korapay_referenceKey" name="korapay_referenceKey" value="' + response.reference + '"/>');
            $form.append('<input type="hidden" class="trans_failure" name="trans_failure" value="' + message + '"/>');
